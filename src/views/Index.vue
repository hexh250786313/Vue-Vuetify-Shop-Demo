<template lang="html">
  ...
  <div class="index">
    <v-header />
    <v-swiper :swiper-data="datas.swiper" />
    <v-service />
    <v-section1
      :list="datas.section1.list"
      :banner="datas.section1.banner"
    />
    <v-section2
      :list="datas.section2.list"
      :banner="datas.section2.banner"
    />i
    <v-section3 />
    <v-section4
      :list="datas.section4.list"
      :banner="datas.section4.banner"
    />
    <v-baseline />
    <v-footer />
  </div>
...
import index from '@/http/mock' // 模拟数据
export default {
  components: {
    'v-header': Header,
    'v-swiper': Swiper,
